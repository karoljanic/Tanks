...
public class PlayerNetwork : MonoBehaviour
{
    ...
    */
    ...
    private void RPC_CreatePlayer()
    {
        ...
        if(PhotonNetwork.isMasterClient)
        {
            obj = PhotonNetwork.Instantiate(Path.Combine("Prefabs", "NewPlayer"), StartPosition1, Quaternion.identity, 0);
        }
        else
        {
            obj = PhotonNetwork.Instantiate(Path.Combine("Prefabs", "NewPlayer"), StartPosition2, Quaternion.identity, 0);
        }
